...
@RestController
@RequestMapping("/api/rmkpro-kafka")
public class RmkproKafkaResource {

    private final Logger log = LoggerFactory.getLogger(RmkproKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public RmkproKafkaResource(KafkaProperties kafkaProperties) {
