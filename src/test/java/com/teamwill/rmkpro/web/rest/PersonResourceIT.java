...
import com.teamwill.rmkpro.domain.Person;
import com.teamwill.rmkpro.repository.PersonRepository;
...
class PersonResourceIT {
    ...
    public static Person createEntity(EntityManager em) {
        Person person = new Person().title(DEFAULT_TITLE).firstNames(DEFAULT_FIRST_NAMES).surname(DEFAULT_SURNAME);
        return person;
    }
    ...
    public static Person createUpdatedEntity(EntityManager em) {
        Person person = new Person().title(UPDATED_TITLE).firstNames(UPDATED_FIRST_NAMES).surname(UPDATED_SURNAME);
        return person;
    }
    ...
    void createPerson() throws Exception {
        ...
        assertThat(testPerson.getFirstNames()).isEqualTo(DEFAULT_FIRST_NAMES);
    ...
    void putNewPerson() throws Exception {
        ...
        updatedPerson.title(UPDATED_TITLE).firstNames(UPDATED_FIRST_NAMES).surname(UPDATED_SURNAME);
        ...
        assertThat(testPerson.getFirstNames()).isEqualTo(UPDATED_FIRST_NAMES);
    ...
    void fullUpdatePersonWithPatch() throws Exception {
        ...
        partialUpdatedPerson.title(UPDATED_TITLE).firstNames(UPDATED_FIRST_NAMES).surname(UPDATED_SURNAME);
